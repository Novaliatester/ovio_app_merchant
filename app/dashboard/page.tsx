        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="card flex h-full flex-col justify-between gap-6">
            <div className="space-y-4">
              <div className="inline-flex items-center rounded-full bg-primary-50 px-3 py-1 text-xs font-semibold text-primary-600">
            ...
            <Link href="/dashboard/offers" className="text-sm font-medium text-primary-600 hover:text-primary-700">
          ...
          <div className="card flex h-full flex-col justify-between gap-6">
            <div className="space-y-4">
              <div className="inline-flex items-center rounded-full bg-green-50 px-3 py-1 text-xs font-semibold text-green-600">
          ...
          <div className="card flex h-full flex-col justify-between gap-6">
            <div className="space-y-4">
              <div className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold ${subscriptionCardTone}`}>
              ...
              {whatsNextItems.map((item, index) => {
                ...
                return (
                  <li key={index} className="flex items-start gap-3">
                    <span className={`mt-1 inline-flex h-2.5 w-2.5 flex-shrink-0 rounded-full ${toneClass}`}></span>
                    {item.label}
                  </li>
                )
              })}
